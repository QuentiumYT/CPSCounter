<h1 align="center" style="font-size: 50px;">Welcome to CPSCounter project 👋</h1>
...
**WINDOWS:** Simply click twice on `CPSCounter.pyw` or run using IDLE

**LINUX:** Not tested yet for GUIs
```bash
python3 CPSCounter.pyw
```
